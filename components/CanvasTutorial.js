...
export const TUT_STEPS = [
  ...
  },
  {
    ...
    body: "See the handle on the edge of your card? Drag it out onto empty canvas to turn this creation into a new connected node. Click Next to finish.",
  },
  {
    mode: "modal",
    title: "You're all set 🎉",
    body: "Connect nodes by dragging their side handles onto empty space to chain steps. Re-open this tour anytime from the “How it works” button.",
    cta: "Finish",
  },
];
